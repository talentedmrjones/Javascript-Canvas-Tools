...
HTMLCanvasElement)throw Error("canvas is required as HTMLCanvasElement, HTMLImageElement, or a string representing the id of a canvas or img element.");this.canvas=a;this.context=this.canvas.getContext("2d");return this};g.Canvas.prototype.setImageData=function(a){this.context.putImageData(a,0,0)};g.Canvas.prototype.getPNG=function(){return this.canvas.toDataURL("image/png")};g.Canvas.prototype.getWidth=function(a,b){this.canvas.width=a;this.canvas.height=b;return this};g.Canvas.prototype.getWidth=
