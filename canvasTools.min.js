...
4)p=h.Blends[a](c[i],c[i+1],c[i+2],c[i+3],b[i],b[i+1],b[i+2],b[i+3],d),b[i]=p[0],b[i+1]=p[1],b[i+2]=p[2],b[i+3]=p[3];this.setImageData(f);"function"==typeof e.post&&e.post.apply(this);return this};h.Canvas.prototype.setCanvas=function(a){typeof a=="string"?a=document.getElementById(a):a.length==0&&(a=document.createElement("canvas"));if(!0===a instanceof HTMLImageElement){var c=document.createElement("canvas");c.width=a.width;c.height=a.height;c.getContext("2d").drawImage(a,0,0);a=c}if(!1===a instanceof
